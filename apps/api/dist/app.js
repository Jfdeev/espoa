...
// ../../node_modules/.pnpm/@neondatabase+serverless@1.1.0/node_modules/@neondatabase/serverless/index.js
var require_serverless = __commonJS({
  "../../node_modules/.pnpm/@neondatabase+serverless@1.1.0/node_modules/@neondatabase/serverless/index.js"(exports2, module2) {
    "use strict";
    ...
    var si = T((Le) => {
      "use strict";
      p();
      var Wt = Nn(), Re = Wn(), jn = typeof Symbol == "function" && typeof Symbol.for == "function" ? Symbol.for("nodejs.util.inspect.custom") : null;
      Le.Buffer = h;
      Le.SlowBuffer = Qo;
      ...
      h.prototype.readFloatLE = a(function(e, t) {
        return e = e >>> 0, t || q(e, 4, this.length), Re.read(this, e, true, 23, 4);
      }, "readFloatLE");
      h.prototype.readFloatBE = a(function(e, t) {
        return e = e >>> 0, t || q(e, 4, this.length), Re.read(this, e, false, 23, 4);
      }, "readFloatBE");
      h.prototype.readDoubleLE = a(function(e, t) {
        return e = e >>> 0, t || q(e, 8, this.length), Re.read(this, e, true, 52, 8);
      }, "readDoubleLE");
      h.prototype.readDoubleBE = a(function(e, t) {
        return e = e >>> 0, t || q(e, 8, this.length), Re.read(
          this,
          e,
          false,
          52,
      ...
      function ti(r, e, t, n, i) {
        return e = +e, t = t >>> 0, i || ei(r, e, t, 4, 34028234663852886e22, -34028234663852886e22), Re.write(r, e, t, n, 23, 4), t + 4;
      }
      a(
        ti,
        "writeFloat"
      ...
      function ri(r, e, t, n, i) {
        return e = +e, t = t >>> 0, i || ei(r, e, t, 8, 17976931348623157e292, -17976931348623157e292), Re.write(
          r,
          e,
          t,
          n,
      ...
      function Xo(r, e, t) {
        Be(e, "offset"), (r[e] === void 0 || r[e + t] === void 0) && Ve(e, r.length - (t + 1));
      }
      a(Xo, "checkBounds");
      ...
      a(Be, "validateNumber");
      function Ve(r, e, t) {
        throw Math.floor(r) !== r ? (Be(r, t), new Pe.ERR_OUT_OF_RANGE(t || "offset", "an integer", r)) : e < 0 ? new Pe.ERR_BUFFER_OUT_OF_BOUNDS() : new Pe.ERR_OUT_OF_RANGE(t || "offset", `>= ${t ? 1 : 0} and <= ${e}`, r);
      }
      a(Ve, "boundsError");
    ...
    function rt(r) {
      let e = 1779033703, t = 3144134277, n = 1013904242, i = 2773480762, s = 1359893119, o = 2600822924, u = 528734635, c = 1541459225, l = 0, f = 0, y = [
        ...
        for (let B = 16; B < 64; B++) {
          let j = g(A[B - 15], 7) ^ g(A[B - 15], 18) ^ A[B - 15] >>> 3, fe = g(
            A[B - 2],
            17
          ) ^ g(A[B - 2], 19) ^ A[B - 2] >>> 10;
          A[B] = A[B - 16] + j + A[B - 7] + fe | 0;
        }
        let I = e, w = t, Z = n, W = i, J = s, X = o, oe = u, ae = c;
        for (let B = 0; B < 64; B++) {
          let j = g(J, 6) ^ g(J, 11) ^ g(J, 25), fe = J & X ^ ~J & oe, me = ae + j + fe + y[B] + A[B] | 0, Ge = g(I, 2) ^ g(
            I,
            13
...
`);
    ...
    var Rt = T((_h, Ls) => {
      "use strict";
      p();
      var fc = (Is(), O(_s)), Bs = it(), Rs = Ps().parse, H = a(function(r, e, t) {
    ...
    var Ws = T((Ft) => {
      ...
      }, "cstringMessage"), Ic = F.addCString("P").flush(68), Tc = F.addCString("S").flush(68), Pc = a((r) => r.name ? mn(68, `${r.type}${r.name || ""}`) : r.type === "P" ? Ic : Tc, "describe"), Rc = a((r) => {
        let e = `${r.type}${r.name || ""}`;
        return mn(67, e);
      }, "close"), Bc = a((r) => F.add(r).flush(100), "copyData"), Lc = a((r) => mn(102, r), "copyFail"), Lt = a((r) => d.from([r, 0, 0, 0, 4]), "codeOnlyBuffer"), Fc = Lt(72), kc = Lt(83), Mc = Lt(88), Uc = Lt(99), Dc = {
        startup: yc,
        password: wc,
        requestSsl: mc,
    ...
    var eo = T((sp, Xs) => {
      "use strict";
      p();
      var Yc = ve().EventEmitter, ip = (at(), O(ot)), Zc = st(), _n = ds(), Jc = Cs(), Xc = At(), el = Rt(), Js = qs(), tl = it(), rl = Cn(), In = class In extends Yc {
        constructor(e) {
    ...
    var io = T((up, no) => {
      ...
      }, "removeWhere"), Rn = class Rn {
        constructor(e, t, n) {
          this.client = e, this.idleListener = t, this.timeoutId = n;
        }
      };
      a(Rn, "IdleItem");
      var Tn = Rn, Bn = class Bn {
        constructor(e) {
          this.callback = e;
        }
      };
    ...
    var yo = T((wp, po) => {
      "use strict";
      p();
      var ll = (oo(), O(so)), fl = At(), mp = ao(), fo = ve().EventEmitter, hl = (at(), O(ot)), pl = Rt(), ho = lo(), K = po.exports = function(r) {
    ...
    function Ea(r, { alphabet: e, scratchArr: t } = {}) {
      if (!ze) if (ze = new Uint16Array(256), gt2 = new Uint16Array(256), Si) for (let C = 0; C < 256; C++) ze[C] = mt[C & 15] << 8 | mt[C >>> 4], gt2[C] = wt[C & 15] << 8 | wt[C >>> 4];
      else for (let C = 0; C < 256; C++) ze[C] = mt[C & 15] | mt[C >>> 4] << 8, gt2[C] = wt[C & 15] | wt[C >>> 4] << 8;
      r.byteOffset % 4 !== 0 && (r = new Uint8Array(r));
      let n = r.length, i = n >>> 1, s = n >>> 2, o = t || new Uint16Array(n), u = new Uint32Array(
        r.buffer,
        r.byteOffset,
        s
      ), c = new Uint32Array(o.buffer, o.byteOffset, i), l = e === "upper" ? gt2 : ze, f = 0, y = 0, g;
      if (Si)
    ...
    function yr(r, {
      ...
      async function Y(P, I, w) {
        let { fetchEndpoint: Z, fetchFunction: W } = se, J = Array.isArray(
          P
        ) ? { queries: P.map((ee) => os(ee)) } : os(P), X = n ?? {}, oe = e ?? false, ae = t ?? false, B = i, j = s, fe = o;
        w !== void 0 && (w.fetchOptions !== void 0 && (X = { ...X, ...w.fetchOptions }), w.arrayMode !== void 0 && (oe = w.arrayMode), w.fullResults !== void 0 && (ae = w.fullResults), w.isolationLevel !== void 0 && (B = w.isolationLevel), w.readOnly !== void 0 && (j = w.readOnly), w.deferrable !== void 0 && (fe = w.deferrable)), I !== void 0 && !Array.isArray(I) && I.fetchOptions !== void 0 && (X = { ...X, ...I.fetchOptions });
        let me = u;
        ...
        Ie && (he.Authorization = `Bearer ${Ie}`), Array.isArray(P) && (B !== void 0 && (he["Neon-Batch-Isolation-Level"] = B), j !== void 0 && (he["Neon-Batch-Read-Only"] = String(j)), fe !== void 0 && (he["Neon-Batch-Deferrable"] = String(fe))), c || se.disableWarningInBrowsers || Ke();
        let we;
        try {
        ...
        if (we.ok) {
          ...
          if (ee === 400) {
            ...
            for (let ge of Bu) $[ge] = M[ge] ?? void 0;
            throw $;
          } else {
            let M = await we.text();
            throw new de(
    ...
    var Un = class Un extends wo.Client {
      ...
      async _handleAuthSASLContinue(t) {
        ...
        let w = P, Z = await n.importKey(
          ...
          "SHA-256",
          W
        ), X = "n=*,r=" + i.clientNonce, oe = "r=" + c + ",s=" + l + ",i=" + y, ae = "c=biws,r=" + c, B = X + "," + oe + "," + ae, j = await n.importKey(
          "raw",
          J,
          { name: "HMAC", hash: { name: "SHA-256" } },
          false,
        ...
        var ee = d.from(
          await n.sign("HMAC", we, A.encode(B))
        );
