...
export default function FinanceiroSaidaPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (!descricao.trim()) nextErrors.descricao = "Informe uma descricao para a saida";
    if (valorFormatError) {
        ...
        <div className="bg-white rounded-2xl border border-[#e5e2dd] shadow-sm overflow-hidden">
          <div className="px-6 py-4 border-b border-[#f0ede8] bg-[#fcfbf9]">
            ...
            <p className="text-sm text-[#6b7170] mt-0.5">
              Registre despesas da associacao — transacoes futuras sao permitidas.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-5">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div className="space-y-2">
                <Label htmlFor="data" className="text-[#1c1c19] font-medium">Data da saida *</Label>
                <Input
                  id="data"
                  name="data"
                  type="date"
            ...
            <div className="space-y-2">
              ...
              <Textarea
                id="descricao"
                name="descricao"
                placeholder="Ex: Combustivel, manutencao de equipamento, aluguel"
            ...
            <div className="flex items-center justify-end pt-2">
              <Button
                type="submit"
                disabled={loading}
                className="h-11 px-8 bg-rose-600 hover:bg-rose-700 text-white rounded-xl font-semibold shadow-sm"
              >
